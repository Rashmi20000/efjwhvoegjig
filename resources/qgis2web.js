...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [79.925748, 6.394151, 80.273658, 6.598677], maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
...
map.getView().fit([79.925748, 6.394151, 80.273658, 6.598677], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">GNDs of Mathugama Pradeshiya Sabha</h2>';
        return titleElement;
    })(),
